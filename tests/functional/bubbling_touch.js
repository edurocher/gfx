		...
		registerSuite({
			...
			"events": function () {
				...
				p = checkEvents(e, p, "rect1", [
					"over rect1 rect1", "move rect1 rect1", "move surface rect1", "press rect1 rect1", "press g rect1",
					"press surface rect1", "release rect1 rect1"
				]);
				p = checkEvents(e, p, "rect2", [
					"over rect2 rect2", "move rect2 rect2", "move surface rect2", "press g rect2", "press surface rect2"
				]);
				p = checkEvents(e, p, "rect3", [
					"over rect3 rect3", "over rect3 rect3", "move surface null", "press g rect3", "press surface rect3"
				]);
