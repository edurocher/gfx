	...
	"intern!object", "intern/chai!assert", "require"
		...
		registerSuite({
			...
			"events": function () {
				...
				return p.waitForCondition("gfxTest.ready", TIMEOUT).elementById("circle").moveTo(50,
						50).buttonDown().moveTo(150,
						150).buttonUp().execute("return gfxTest.circle.getBoundingBox();").then(function (bbox) {
